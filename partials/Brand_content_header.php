          ...
          <div class="header-elements">
            <div class="list-icons">
              ...
              <ul class="list-inline list-inline-condensed mt-3 mb-0">
                ...
                <li class="list-inline-item" title="PDF"><a href="brand_download_pdf.php" class="btn btn-outline bg-indigo-800 btn-icon text-indigo-800 border-indigo-800 border-2 rounded-round">
                    <i class="icon-file-pdf"></i></a>
                </li>
                <li class="list-inline-item" title="Print"><a href="brand_print.php" target="_blank" class="btn btn-outline bg-primary-800 btn-icon text-primary-800 border-purple-800 border-2 rounded-round">
